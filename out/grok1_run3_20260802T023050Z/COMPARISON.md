...
|-------|----------|----------|
| Path | `out/grok1_run2_after_fixes_20260525T002904Z` | `out/grok1_run3_20260802T023050Z` |
...
| Horizon | Work |
|---------|------|
| Short | Point grok-ozempic at `out/LATEST_CORRECT_GROK1_RUN/manifests/xai-grok-1-ckpt-0/` |
